...
export const environment = {
  ...
  url_face: 'https://westus.api.cognitive.microsoft.com/face/v1.0/detect?returnFaceId=true&returnFaceLandmarks=false&returnFaceAttributes=smile,glasses,facialHair,age,gender,hair',
